...
from flask import Flask # أضفنا فلاسك لحل مشكلة بورت ريندر
...
def run_web_server():
    # ريندر يبحث عن منفذ (Port) في خدمات الويب
...
if __name__ == "__main__":
    # تشغيل سيرفر الويب في خيط منفصل لحل مشكلة Port Binding في Render
